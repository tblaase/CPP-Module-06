...
![result](https://github.com/tblaase/CPP-Module-06/blob/main/readme_additions/result.png)
...
After that, run the created executable like `./executable_to_run` (ie. ex00 `./Conversion`).<br>
